...
def greens_theorem(xvec,yvec):
    ...
    return np.abs(mysum) # Area is expected to be physical i.e. strictly positive
...
#     plt.title(f"Area = {greens_theorem(x_points,y_points)}")
#     plt.show()
